...
# data = pd.read_csv('your_data.csv', index_col='Date', parse_dates=True)  # Uncomment if you have your own data
# For the purpose of this example, let's generate a synthetic series
data = pd.Series([1, 2, 3, 4, 5, 4, 3, 2, 1, 0, -1, -2, -3, -4])
...
# Example: Perform ADF test on the data
adf_test(data)
...
# Example: Plot rolling statistics
